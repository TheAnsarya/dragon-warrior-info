...
try:
	from dw_text_encoding import (
		encode_text as dw_encode_text,
		decode_bytes as dw_decode_bytes,
		BYTE_TO_CHAR as TBL_BYTE_TO_CHAR,
		CHAR_TO_BYTE as TBL_CHAR_TO_BYTE,
...
# Default Dragon Warrior text table - CORRECT TBL encoding
# Uses dw_text_encoding module if available, fallback to inline definition
if _HAS_DW_ENCODING:
	DEFAULT_TEXT_TABLE = TBL_BYTE_TO_CHAR
else:
	# Fallback: correct TBL encoding if module not available
	DEFAULT_TEXT_TABLE = {
		# Numbers (0x00-0x09)
